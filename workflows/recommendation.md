...
### 45 志愿全表列结构（`FINAL-志愿方案.md`）

冲/稳/保四段表头：

| 序 | 院校名称·专业组 | 2026预测 | 偏差 | **校专综评** | **推荐依据** | **前景** | 组内专业 1→6 |

**校专综评**四段格式：`字母｜校:…｜专:…｜业:…｜匹:…`

| 段 | 含义 |
|----|------|
| 字母 | S/A/B+/B/C 综合档 |
| 校 | 层次 + 软科总榜 + 行业地位 |
| 专 | 本科专业实力 + 学科评估（够硬/很硬/中等/偏弱） |
| 业 | 就业认可度 |
| 匹 | ADI、地域④③②①、家长、位次层级 |

**前景**列：`发展·就业·AI`，如 `增量·极强·🟡中`；展开见 `11-major-outlook.md`。
...
**下一步**：按 FINAL 序 1→N 录入省系统；可选模式 B 终审。
```
...
用户触发「交接/审核」时，在总结果输出之后**另附** [agent-handoff.md](../shared/agent-handoff.md) 的交接提示词块。
